...
import { createMenuFormSchema } from "@/schema";
import { menutags } from "@/data";
...
const CreateItem = () => {
  ...
  const form = useForm<z.infer<typeof createMenuFormSchema>>({
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            This will add new menu to the restaurant existing menus
          </DialogDescription>
        </DialogHeader>
        <div>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="space-y-3">
                {groupFields.map((_group, groupIndex) => {
                  return (
                    <div className="space-y-3">
              ...
              >
                {mutation.isPending ? <Spinner /> : "Create New Menu"}
              </Button>
            </form>
          </Form>
        </div>
